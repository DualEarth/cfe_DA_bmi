#!/usr/bin/env bash
# Batch DA for all 21 catchments — F1 Vrugt R formula.
# R = (0.10 * Q)^2 + 0.001 * krig_var  (no hardcoded-r)
...
echo ""
echo "=== F1 done: done=$DONE  skipped=$SKIP  failed=$FAIL ==="
