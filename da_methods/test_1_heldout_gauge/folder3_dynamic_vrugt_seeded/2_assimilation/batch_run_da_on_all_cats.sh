#!/usr/bin/env bash
# Batch DA for all 21 catchments — F3 Vrugt R, seeded (seed=42).
# R = (0.10 * Q)^2 + 0.001 * krig_var  with rng-seed=42 for reproducibility.
...
OUT_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder3_dynamic_vrugt_seeded
...
mkdir -p "$OUT_DIR"
echo "F3 Vrugt seeded (seed=42) DA — obs: $OBS_DIR"
echo "                               out: $OUT_DIR"
echo ""
...
echo ""
echo "=== F3 done: done=$DONE  skipped=$SKIP  failed=$FAIL ==="
