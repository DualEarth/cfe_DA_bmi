#!/usr/bin/env bash
# F4 dynamic variance direct (1 gauge holdout) — route lead-time forecast CSVs.
...
#
# Run AFTER batch_run_leadtime_f4.sh finishes.
#
# Usage:
#   bash route_leadtime_f4.sh
...
OUT_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder4_dynamic_variance_direct_leadtime_routed

echo "[F4] Routing lead-time forecasts through T-route..."
echo "  forecast-dir: $F4_DIR"
...
echo "[F4] Lead-time routing done. Outputs in: $OUT_DIR"
