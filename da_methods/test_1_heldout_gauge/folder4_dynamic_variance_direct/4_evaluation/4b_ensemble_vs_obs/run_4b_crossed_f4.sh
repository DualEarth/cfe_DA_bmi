#!/usr/bin/env bash
# F4 Direct variance (1 gauge holdout) — 4b crossed ensemble plots.
...
DATA_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder4_dynamic_variance_direct
