#!/usr/bin/env bash
# F4 Direct variance (1 gauge holdout) — 4a lead-time decay plots.
#
# Requires lead-time forecast CSVs generated by batch_run_leadtime_f4.sh first.
# Gauge-level decay plot is skipped if routed parquets don't exist yet.
#
# Usage:
#   bash run_4a_f4.sh
...
DA_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder4_dynamic_variance_direct
