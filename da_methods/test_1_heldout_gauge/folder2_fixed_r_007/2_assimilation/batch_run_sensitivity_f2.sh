#!/usr/bin/env bash
# Batch perturbation sensitivity analysis — F2 Fixed R=0.07, 1 gauge holdout.
...
#
# Usage:
#   nohup bash ~/da_1gauge_f2/2_assimilation/batch_run_sensitivity_f2.sh \
#       > ~/sensitivity_f2.log 2>&1 &
...
echo "F2 sensitivity analysis — out: $OUT_DIR"
echo ""
...
echo ""
echo "=== F2 sensitivity done: done=$DONE  skipped=$SKIP  failed=$FAIL ==="
