#!/usr/bin/env bash
# Batch DA for all 21 catchments — F2 fixed R=0.07.
# R = 0.07 (hardcoded, constant observation error variance)
...
mkdir -p "$OUT_DIR"
echo "F2 Fixed R=0.07 DA — obs: $OBS_DIR"
echo "                     out: $OUT_DIR"
echo ""
...
echo ""
echo "=== F2 done: done=$DONE  skipped=$SKIP  failed=$FAIL ==="
