#!/usr/bin/env bash
# F2 fixed R=0.07 (1 gauge holdout) — route lead-time forecast CSVs.
...
#
# Run AFTER batch_run_leadtime_f2.sh finishes.
#
# Usage:
...
OUT_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder2_fixed_r007_leadtime_routed
