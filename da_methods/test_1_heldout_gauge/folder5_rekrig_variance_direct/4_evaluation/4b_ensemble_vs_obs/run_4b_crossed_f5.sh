...
DATA_DIR=/mnt/disk2/suma_helen_poster/da_results_1gauge_heldout/folder5_rekrig_variance_direct
...
echo "[F5-4b-crossed] Crossed ensemble plots — data: $DATA_DIR"
