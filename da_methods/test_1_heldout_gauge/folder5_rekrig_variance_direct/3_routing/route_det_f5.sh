#!/usr/bin/env bash
# F5 re-kriging direct variance (1 gauge holdout) — deterministic T-route routing.
# Routes per-catchment _test_results.csv (sim_mm_h) through Muskingum-Cunge
# to gauge 03463300 and writes routed_Q_test.csv + KGE/NSE summary.
#
# Usage:
#   bash route_det_f5.sh
...
KV_DIR=/mnt/disk2/1400_sites_helene/catchment_ts_no_03463300_dynamic_variance_rekrig

echo "[F5] Deterministic T-route routing..."
echo "  da-dir : $F5_DIR"
echo "  out-dir: $F5_DIR"
echo "  kv-dir : $KV_DIR"
...
echo "[F5] Deterministic routing done. Output: $F5_DIR/routed_Q_test.csv"
