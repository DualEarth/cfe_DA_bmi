#!/usr/bin/env bash
# F5 re-kriging direct variance (1 gauge holdout) — crossed-ensemble T-route routing.
...
#
# Must be run AFTER crossed ensemble parquets exist in F5_DIR.
#
# Usage:
#   bash route_ensemble_f5.sh
...
echo "[F5] Crossed-ensemble T-route routing..."
echo "  ensemble-dir: $F5_DIR"
echo "  out-dir     : $F5_DIR"
...
echo "[F5] Ensemble routing done. Output: $F5_DIR/routed_crossed_ensemble.parquet"
