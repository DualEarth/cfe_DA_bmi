#!/usr/bin/env bash
# Batch perturbation sensitivity analysis — F5 re-kriged variance, 1 gauge holdout.
...
#
# Usage:
#   nohup bash ~/da_1gauge_f5/2_assimilation/batch_run_sensitivity_f5.sh \
#       > ~/sensitivity_f5.log 2>&1 &
...
echo "F5 sensitivity analysis — out: $OUT_DIR"
echo ""
...
echo ""
echo "=== F5 sensitivity done: done=$DONE  skipped=$SKIP  failed=$FAIL ==="
