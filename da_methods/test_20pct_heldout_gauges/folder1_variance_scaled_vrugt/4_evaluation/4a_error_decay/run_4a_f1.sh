#!/usr/bin/env bash
# F1 variance-scaled Vrugt (20pct gauge holdout) — 4a lead-time decay plots.
#
...
DA_DIR=/mnt/disk2/suma_helen_poster/da_results/v2_perturbation_da_on
...
# Gauge-level decay (needs routed parquets — run after route_leadtime_f1.sh)
