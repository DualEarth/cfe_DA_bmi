#!/usr/bin/env bash
# F1 variance-scaled Vrugt (20pct gauge holdout) — crossed-ensemble T-route routing.
...
echo "[F1] Ensemble routing done. Output: $CROSSED_DIR/routed_crossed_ensemble.parquet"
