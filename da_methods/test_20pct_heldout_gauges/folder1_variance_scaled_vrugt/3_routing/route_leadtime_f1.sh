#!/usr/bin/env bash
# F1 variance-scaled Vrugt (20pct gauge holdout) — route lead-time forecast CSVs.
...
F1_DIR=/mnt/disk2/suma_helen_poster/da_results/v2_lead_time_forecast
GPKG=/mnt/disk1/usgs_streamflow_allgauges/subdaily_15min/test/gage-03463300_subset.gpkg
OUT_DIR=/mnt/disk2/suma_helen_poster/leadtime_troute_routing
