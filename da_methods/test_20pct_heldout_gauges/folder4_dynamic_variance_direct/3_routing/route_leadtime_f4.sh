#!/usr/bin/env bash
# F4 dynamic variance direct (20pct gauge holdout) — route lead-time forecast CSVs.
...
F4_DIR=/mnt/disk2/1400_sites_helene/da_forecast_dynamic_novrugt_seeded
GPKG=/mnt/disk1/usgs_streamflow_allgauges/subdaily_15min/test/gage-03463300_subset.gpkg
OUT_DIR=/mnt/disk2/suma_helen_poster/leadtime_troute_routing_f4
