#!/usr/bin/env bash
# F4 dynamic variance direct (20pct gauge holdout) — crossed-ensemble T-route routing.
...
echo "[F4] Ensemble routing done. Output: $CROSSED_DIR/routed_crossed_ensemble.parquet"
