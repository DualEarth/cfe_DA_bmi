#!/usr/bin/env bash
# F4 dynamic variance direct (20pct gauge holdout) — 4a lead-time decay plots.
#
...
LEADTIME_DIR=/mnt/disk2/1400_sites_helene/da_forecast_dynamic_novrugt_seeded
DA_DIR=/mnt/disk2/1400_sites_helene/da_arms_dynamic_novrugt_seeded
OBS_DIR=/mnt/disk2/1400_sites_helene/catchment_ts_03463300_spliced_dyn_helene
ROUTE_DIR=/mnt/disk2/suma_helen_poster/leadtime_troute_routing_f4
...
echo "[F4-4a] Lead-time decay plots — leadtime dir: $LEADTIME_DIR"
...
# Gauge-level decay (needs routed parquets — run after route_leadtime_f4.sh)
