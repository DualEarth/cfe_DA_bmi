#!/usr/bin/env bash
# F2 fixed R=0.07 (20pct gauge holdout) — 4a lead-time decay plots.
#
...
DA_DIR=/mnt/disk2/suma_helen_poster/da_results/v2_fixed_r007_analysis
...
# Gauge-level decay (needs routed parquets — run after route_leadtime_f2.sh)
